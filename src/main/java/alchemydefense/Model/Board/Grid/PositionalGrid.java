...
public class PositionalGrid {
    ...
    public void add(Tower boardObject, Vector2Int cell){
        if (!positionalCells[cell.getX()][cell.getY()].isOccupiedByTower()){
            positionalCells[cell.getX()][cell.getY()].addTower(boardObject);
        }
    }
    ...
    public boolean addTower(Tower tower, Vector2Int cell){
        if (!positionalCells[cell.getX()][cell.getY()].isOccupiedByTower()){
            positionalCells[cell.getX()][cell.getY()].addTower(tower);
            return true;
        }
        return false;
    }
    ...
    public void addFoe(Foe foe, Vector2Int cell){
        positionalCells[cell.getX()][cell.getY()].addFoe(foe);
    }
    ...
    public void remove(Vector2Int cell){
        if(positionalCells[cell.getX()][cell.getY()].isOccupiedByTower()){
            positionalCells[cell.getX()][cell.getY()].setOccupied(false);
            positionalCells[cell.getX()][cell.getY()].clear();
        }
    }

    public PositionalCell getCell(Vector2Int cell){
        return positionalCells[cell.getX()][cell.getY()];
    }

    public BoardObject getBoardObject(Vector2Int cell){
        return positionalCells[cell.getX()][cell.getY()].getBoardObject();
    }
